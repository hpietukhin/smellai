...
Usage:
    ...
    uv run scripts/manage_datasets.py list --experiment rminer-evaluation

    # Get dataset details
    uv run scripts/manage_datasets.py get --name rminer-eval-dataset

    # Get dataset by ID
    uv run scripts/manage_datasets.py get --id d-abc123

    # Export dataset to JSON
    uv run scripts/manage_datasets.py export --name rminer-eval-dataset -o dataset.json

    # Delete dataset
    uv run scripts/manage_datasets.py delete --name rminer-eval-dataset
"""
