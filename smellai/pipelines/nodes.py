...
from smellai.agents.detector import detect_smells as detect_smells_agent
from smellai.agents.judge import evaluate_detections
from smellai.data.git_ops import (
    clone_and_read_file,
    derive_repo_url,
    get_commit_before_date,
)
from smellai.data.mysql_connector import fetch_sample_by_id
from smellai.models.entities import EvaluationResult, SmellAnnotation, SmellDetection
...
def detect_smells_node(state: EvaluationState) -> EvaluationState:
    ...
    **Note**: Requires retriever to be initialized externally and passed via closure
    ...
    try:
        ...
        from smellai.pipelines.evaluation_pipeline import get_retriever_instance
